...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse register(UserRegistrationRequest request) {
        ...
        User user = userRepository.findByEmailWithRoles(userResponse.getEmail())
                        .orElseThrow(() -> {
                            log.error("Registered user not found in database. email={}", userResponse.getEmail());
    ...
    public AuthResponse refreshToken(String refreshTokenValue) {
        ...
        UserDetails userDetails = new UserInfoConfig(user);
        String accessToken = jwtService.generateAccessToken(userDetails);
        log.info("Access token refreshed successfully. userId={}, email={}", user.getUserId(), user.getEmail());
        return AuthResponse.builder()
                .accessToken(accessToken)
                .refreshToken(refreshToken.getToken())
                .tokenType("Bearer")
    ...
    public void resetPassword(String tokenValue, String newPassword) {
        PasswordResetToken token = passwordResetTokenRepository
                        ...
                        .orElseThrow(() ->
                                new APIException("Invalid reset token"));
